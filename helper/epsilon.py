...
def get_epsilon_neighbors(
    vector, all_vectors, epsilon=0.01
):  # we can experiment on the value of epislon
...
@continuous_scorer()
def sentence_transformer_similarity_with_vicinity(
    sentence, all_statements, epsilon=0.01, **kwargs
):
