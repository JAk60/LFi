...
def LOGISTIC_TIMELF1(x):
    log_file = f"./csv/LOGISTIC_TIMELF1_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def LOGISTIC_TIMELF2(x):
    log_file = f"./csv/LOGISTIC_TIMELF2_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def LOGISTIC_TIMELF3(x):
    log_file = f"./csv/LOGISTIC_TIMELF3_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def LOGISTIC_TIMELF4(x):
    log_file = f"./csv/LOGISTIC_TIMELF4_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def LOGISTIC_TIMELF5(x):
    log_file = f"./csv/LOGISTIC_TIMELF5_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def LOGISTIC_TIMELF6(x):
    log_file = f"./csv/LOGISTIC_TIMELF6_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def LOGISTIC_TIMELF7(x):
    log_file = f"./csv/LOGISTIC_TIMELF7_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def LOGISTIC_TIMELF8(x):
    log_file = f"./csv/LOGISTIC_TIMELF8_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def LOGISTIC_TIMELF9(x):
    log_file = f"./csv/LOGISTIC_TIMELF9_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def LOGISTIC_TIMELF10(x):
    log_file = f"./csv/LOGISTIC_TIMELF10_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
LOGISTIC_TIMELFS = [
    LOGISTIC_TIMELF1, LOGISTIC_TIMELF2, LOGISTIC_TIMELF3, LOGISTIC_TIMELF4, LOGISTIC_TIMELF5, LOGISTIC_TIMELF6, LOGISTIC_TIMELF7, LOGISTIC_TIMELF8, LOGISTIC_TIMELF9, LOGISTIC_TIMELF10
]