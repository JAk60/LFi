...
def ACTIVITY_SEQUENCESLF3(x):
    result = (
        ClassLabels.ACTIVITY_SEQUENCES
        if extractor.apply_rule(
            "If coordination between different naval units is critical.", x
        )
        == True
        else ABSTAIN
    )
...
def ACTIVITY_SEQUENCESLF4(x):
    result = (
        ClassLabels.ACTIVITY_SEQUENCES
        if extractor.apply_rule(
            "If the timing of actions is crucial for tactical advantage.", x
        )
        == True
        else ABSTAIN
    )
...
def ACTIVITY_SEQUENCESLF5(x):
    result = (
        ClassLabels.ACTIVITY_SEQUENCES
        if extractor.apply_rule(
            "If the sequence of logistical support must be maintained.", x
        )
        == True
        else ABSTAIN
    )
...
def ACTIVITY_SEQUENCESLF6(x):
    result = (
        ClassLabels.ACTIVITY_SEQUENCES
        if extractor.apply_rule(
            "If the order of operations affects the outcome of the mission.", x
        )
        == True
        else ABSTAIN
    )
...
def ACTIVITY_SEQUENCESLF8(x):
    result = (
        ClassLabels.ACTIVITY_SEQUENCES
        if extractor.apply_rule(
            "If the sequence of reconnaissance and surveillance is predefined.", x
        )
        == True
        else ABSTAIN
    )
...
def ACTIVITY_SEQUENCESLF9(x):
    result = (
        ClassLabels.ACTIVITY_SEQUENCES
        if extractor.apply_rule(
            "If the activities must be synchronized with allied forces.", x
        )
        == True
        else ABSTAIN
    )
...
def ACTIVITY_SEQUENCESLF10(x):
    result = (
        ClassLabels.ACTIVITY_SEQUENCES
        if extractor.apply_rule(
            "If the sequence of activities is dependent on real-time intelligence.", x
        )
        == True
        else ABSTAIN
    )
...
ACTIVITY_SEQUENCESLFS = [
    ACTIVITY_SEQUENCESLF1,
    ACTIVITY_SEQUENCESLF2,
    ACTIVITY_SEQUENCESLF3,
    ACTIVITY_SEQUENCESLF4,
    ACTIVITY_SEQUENCESLF5,
    ACTIVITY_SEQUENCESLF6,
    ACTIVITY_SEQUENCESLF7,
    ACTIVITY_SEQUENCESLF8,
    ACTIVITY_SEQUENCESLF9,
    ACTIVITY_SEQUENCESLF10,
]
