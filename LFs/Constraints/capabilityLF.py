...
def CAPABILITYLF1(x):
    result = (
        ClassLabels.CAPABILITY
        if extractor.apply_rule(
            "If the ship must have advanced radar systems for surveillance.", x
        )
        == True
        else ABSTAIN
    )
...
def CAPABILITYLF2(x):
    result = (
        ClassLabels.CAPABILITY
        if extractor.apply_rule(
            "If the ship must be equipped with anti-submarine warfare capabilities.", x
        )
        == True
        else ABSTAIN
    )
...
def CAPABILITYLF3(x):
    result = (
        ClassLabels.CAPABILITY
        if extractor.apply_rule("If the ship must have long-range missile systems.", x)
        == True
        else ABSTAIN
    )
    if LOGGING_ENABLED and result != ABSTAIN:
...
def CAPABILITYLF5(x):
    result = (
        ClassLabels.CAPABILITY
        if extractor.apply_rule(
            "If the ship must be capable of conducting amphibious operations.", x
        )
        == True
        else ABSTAIN
    )
...
def CAPABILITYLF6(x):
    result = (
        ClassLabels.CAPABILITY
        if extractor.apply_rule(
            "If the ship must have electronic warfare capabilities.", x
        )
        == True
        else ABSTAIN
    )
...
def CAPABILITYLF7(x):
    result = (
        ClassLabels.CAPABILITY
        if extractor.apply_rule(
            "If the ship must be equipped with unmanned aerial vehicles (UAVs).", x
        )
        == True
        else ABSTAIN
    )
...
def CAPABILITYLF8(x):
    result = (
        ClassLabels.CAPABILITY
        if extractor.apply_rule(
            "If the ship must have medical facilities for emergency care.", x
        )
        == True
        else ABSTAIN
    )
...
def CAPABILITYLF9(x):
    result = (
        ClassLabels.CAPABILITY
        if extractor.apply_rule(
            "If the ship must be capable of conducting search and rescue operations.", x
        )
        == True
        else ABSTAIN
    )
...
def CAPABILITYLF10(x):
    result = (
        ClassLabels.CAPABILITY
        if extractor.apply_rule(
            "If the ship must have advanced sonar systems for underwater detection.", x
        )
        == True
        else ABSTAIN
    )
