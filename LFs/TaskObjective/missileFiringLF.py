...
def MissileFiringLF1(x):
    log_file = f"D:/IITB/LF/LFs/Task Objective/csv/MissileFiringLF1_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def MissileFiringLF2(x):
    log_file = f"D:/IITB/LF/LFs/Task Objective/csv/MissileFiringLF2_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def MissileFiringLF3(x):
    log_file = f"D:/IITB/LF/LFs/Task Objective/csv/MissileFiringLF3_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def MissileFiringLF4(x):
    log_file = f"D:/IITB/LF/LFs/Task Objective/csv/MissileFiringLF4_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def MissileFiringLF5(x):
    log_file = f"D:/IITB/LF/LFs/Task Objective/csv/MissileFiringLF5_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def MissileFiringLF6(x):
    log_file = f"D:/IITB/LF/LFs/Task Objective/csv/MissileFiringLF6_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def MissileFiringLF7(x):
    log_file = f"D:/IITB/LF/LFs/Task Objective/csv/MissileFiringLF7_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def MissileFiringLF8(x):
    log_file = f"D:/IITB/LF/LFs/Task Objective/csv/MissileFiringLF8_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def MissileFiringLF9(x):
    log_file = f"D:/IITB/LF/LFs/Task Objective/csv/MissileFiringLF9_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def MissileFiringLF10(x):
    log_file = f"D:/IITB/LF/LFs/Task Objective/csv/MissileFiringLF10_logs_{datetime.now().strftime('%Y%m%d')}.csv"
