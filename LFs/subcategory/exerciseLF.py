...
def Exercise_LF1(x):
    log_file = f"./csv/Exercise_LF1_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Exercise)
def Exercise_LF2(x):
    log_file = f"./csv/Exercise_LF2_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Exercise)
def Exercise_LF3(x):
    log_file = f"./csv/Exercise_LF3_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Exercise)
def Exercise_LF4(x):
    log_file = f"./csv/Exercise_LF4_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Exercise)
def Exercise_LF5(x):
    log_file = f"./csv/Exercise_LF5_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Exercise)
def Exercise_LF6(x):
    log_file = f"./csv/Exercise_LF6_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Exercise)
def Exercise_LF7(x):
    log_file = f"./csv/Exercise_LF7_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Exercise)
def Exercise_LF8(x):
    log_file = f"./csv/Exercise_LF8_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Exercise)
def Exercise_LF9(x):
    log_file = f"./csv/Exercise_LF9_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Exercise)
def Exercise_LF10(x):
    log_file = f"./csv/Exercise_LF10_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
Exercise_LFS = [
    Exercise_LF1, Exercise_LF2, Exercise_LF3, Exercise_LF4, Exercise_LF5, Exercise_LF6, Exercise_LF7, Exercise_LF8, Exercise_LF9, Exercise_LF10
]