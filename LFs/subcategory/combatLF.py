...
def Combat_LF1(x):
    log_file = f"./csv/Combat_LF1_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Combat)
def Combat_LF2(x):
    log_file = f"./csv/Combat_LF2_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Combat)
def Combat_LF3(x):
    log_file = f"./csv/Combat_LF3_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Combat)
def Combat_LF4(x):
    log_file = f"./csv/Combat_LF4_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Combat)
def Combat_LF5(x):
    log_file = f"./csv/Combat_LF5_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Combat)
def Combat_LF6(x):
    log_file = f"./csv/Combat_LF6_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Combat)
def Combat_LF7(x):
    log_file = f"./csv/Combat_LF7_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Combat)
def Combat_LF8(x):
    log_file = f"./csv/Combat_LF8_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Combat)
def Combat_LF9(x):
    log_file = f"./csv/Combat_LF9_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Combat)
def Combat_LF10(x):
    log_file = f"./csv/Combat_LF10_logs_{datetime.now().strftime('%Y%m%d')}.csv"
