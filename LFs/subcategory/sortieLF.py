...
def Sortie_LF1(x):
    log_file = f"./csv/Sortie_LF1_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Fleetsupport)
def Sortie_LF2(x):
    log_file = f"./csv/Sortie_LF2_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Fleetsupport)
def Sortie_LF3(x):
    log_file = f"./csv/Sortie_LF3_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Fleetsupport)
def Sortie_LF4(x):
    log_file = f"./csv/Sortie_LF4_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Fleetsupport)
def Sortie_LF5(x):
    log_file = f"./csv/Sortie_LF5_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Fleetsupport)
def Sortie_LF6(x):
    log_file = f"./csv/Sortie_LF6_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Fleetsupport)
def Sortie_LF7(x):
    log_file = f"./csv/Sortie_LF7_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Fleetsupport)
def Sortie_LF8(x):
    log_file = f"./csv/Sortie_LF8_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Fleetsupport)
def Sortie_LF9(x):
    log_file = f"./csv/Sortie_LF9_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Fleetsupport)
def Sortie_LF10(x):
    log_file = f"./csv/Sortie_LF10_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
Sortie_LFS = [
    Sortie_LF1, Sortie_LF2, Sortie_LF3, Sortie_LF4, Sortie_LF5, Sortie_LF6, Sortie_LF7, Sortie_LF8, Sortie_LF9, Sortie_LF10
]