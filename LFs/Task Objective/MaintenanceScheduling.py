...
def MaintenanceSchedulingLF1(x):
    log_file = f"./csv/MaintenanceSchedulingLF1_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def MaintenanceSchedulingLF2(x):
    log_file = f"./csv/MaintenanceSchedulingLF2_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def MaintenanceSchedulingLF3(x):
    log_file = f"./csv/MaintenanceSchedulingLF3_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def MaintenanceSchedulingLF4(x):
    log_file = f"./csv/MaintenanceSchedulingLF4_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def MaintenanceSchedulingLF5(x):
    log_file = f"./csv/MaintenanceSchedulingLF5_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def MaintenanceSchedulingLF6(x):
    log_file = f"./csv/MaintenanceSchedulingLF6_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def MaintenanceSchedulingLF7(x):
    log_file = f"./csv/MaintenanceSchedulingLF7_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def MaintenanceSchedulingLF8(x):
    log_file = f"./csv/MaintenanceSchedulingLF8_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def MaintenanceSchedulingLF9(x):
    log_file = f"./csv/MaintenanceSchedulingLF9_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def MaintenanceSchedulingLF10(x):
    log_file = f"./csv/MaintenanceSchedulingLF10_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
MaintenanceSchedulingLFS = [
    MaintenanceSchedulingLF1, MaintenanceSchedulingLF2, MaintenanceSchedulingLF3, MaintenanceSchedulingLF4, MaintenanceSchedulingLF5, MaintenanceSchedulingLF6, MaintenanceSchedulingLF7, MaintenanceSchedulingLF8, MaintenanceSchedulingLF9, MaintenanceSchedulingLF10
]
