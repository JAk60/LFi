...
def InterrogationInterceptionLF1(x):
    log_file = f"./csv/InterrogationInterceptionLF1_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def InterrogationInterceptionLF2(x):
    log_file = f"./csv/InterrogationInterceptionLF2_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def InterrogationInterceptionLF3(x):
    log_file = f"./csv/InterrogationInterceptionLF3_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def InterrogationInterceptionLF4(x):
    log_file = f"./csv/InterrogationInterceptionLF4_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def InterrogationInterceptionLF5(x):
    log_file = f"./csv/InterrogationInterceptionLF5_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def InterrogationInterceptionLF6(x):
    log_file = f"./csv/InterrogationInterceptionLF6_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def InterrogationInterceptionLF7(x):
    log_file = f"./csv/InterrogationInterceptionLF7_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def InterrogationInterceptionLF8(x):
    log_file = f"./csv/InterrogationInterceptionLF8_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def InterrogationInterceptionLF9(x):
    log_file = f"./csv/InterrogationInterceptionLF9_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def InterrogationInterceptionLF10(x):
    log_file = f"./csv/InterrogationInterceptionLF10_logs_{datetime.now().strftime('%Y%m%d')}.csv"
