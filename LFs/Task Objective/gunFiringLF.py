...
def GunfiringLF1(x):
    log_file = f"./csv/GunfiringLF1_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Gunfiring)
def GunfiringLF2(x):
    log_file = f"./csv/GunfiringLF2_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Gunfiring)
def GunfiringLF3(x):
    log_file = f"./csv/GunfiringLF3_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Gunfiring)
def GunfiringLF4(x):
    log_file = f"./csv/GunfiringLF4_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Gunfiring)
def GunfiringLF5(x):
    log_file = f"./csv/GunfiringLF5_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Gunfiring)
def GunfiringLF6(x):
    log_file = f"./csv/GunfiringLF6_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Gunfiring)
def GunfiringLF7(x):
    log_file = f"./csv/GunfiringLF7_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Gunfiring)
def GunfiringLF8(x):
    log_file = f"./csv/GunfiringLF8_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Gunfiring)
def GunfiringLF9(x):
    log_file = f"./csv/GunfiringLF9_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
@labeling_function(pre=[convert_to_lower], label=ClassLabels.Gunfiring)
def GunfiringLF10(x):
    log_file = f"./csv/GunfiringLF10_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
GunfiringLFS = [
    GunfiringLF1, GunfiringLF2, GunfiringLF3, GunfiringLF4, GunfiringLF5, GunfiringLF6, GunfiringLF7, GunfiringLF8, GunfiringLF9, GunfiringLF10
]
