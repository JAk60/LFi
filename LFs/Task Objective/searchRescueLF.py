...
def SearchAndRescueLF1(x):
    log_file = f"./csv/SearchAndRescueLF1_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def SearchAndRescueLF2(x):
    log_file = f"./csv/SearchAndRescueLF2_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def SearchAndRescueLF3(x):
    log_file = f"./csv/SearchAndRescueLF3_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def SearchAndRescueLF4(x):
    log_file = f"./csv/SearchAndRescueLF4_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def SearchAndRescueLF5(x):
    log_file = f"./csv/SearchAndRescueLF5_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def SearchAndRescueLF6(x):
    log_file = f"./csv/SearchAndRescueLF6_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def SearchAndRescueLF7(x):
    log_file = f"./csv/SearchAndRescueLF7_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def SearchAndRescueLF8(x):
    log_file = f"./csv/SearchAndRescueLF8_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def SearchAndRescueLF9(x):
    log_file = f"./csv/SearchAndRescueLF9_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def SearchAndRescueLF10(x):
    log_file = f"./csv/SearchAndRescueLF10_logs_{datetime.now().strftime('%Y%m%d')}.csv"
