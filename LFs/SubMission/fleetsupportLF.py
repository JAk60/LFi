...
def Fleetsupport_LF1(x):
    log_file = f"D:/IITB/LF/LFs/SubMission/csv/Fleetsupport_LF1_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def Fleetsupport_LF2(x):
    log_file = f"D:/IITB/LF/LFs/SubMission/csv/Fleetsupport_LF2_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def Fleetsupport_LF3(x):
    log_file = f"D:/IITB/LF/LFs/SubMission/csv/Fleetsupport_LF3_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def Fleetsupport_LF4(x):
    log_file = f"D:/IITB/LF/LFs/SubMission/csv/Fleetsupport_LF4_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def Fleetsupport_LF5(x):
    log_file = f"D:/IITB/LF/LFs/SubMission/csv/Fleetsupport_LF5_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def Fleetsupport_LF6(x):
    log_file = f"D:/IITB/LF/LFs/SubMission/csv/Fleetsupport_LF6_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def Fleetsupport_LF7(x):
    log_file = f"D:/IITB/LF/LFs/SubMission/csv/Fleetsupport_LF7_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def Fleetsupport_LF8(x):
    log_file = f"D:/IITB/LF/LFs/SubMission/csv/Fleetsupport_LF8_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def Fleetsupport_LF9(x):
    log_file = f"D:/IITB/LF/LFs/SubMission/csv/Fleetsupport_LF9_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def Fleetsupport_LF10(x):
    log_file = f"D:/IITB/LF/LFs/SubMission/csv/Fleetsupport_LF10_logs_{datetime.now().strftime('%Y%m%d')}.csv"
