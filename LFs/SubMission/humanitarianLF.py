...
def Humanitarian_LF1(x):
    log_file = f"D:/IITB/LF/LFs/SubMission/csv/Humanitarian_LF1_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def Humanitarian_LF2(x):
    log_file = f"D:/IITB/LF/LFs/SubMission/csv/Humanitarian_LF2_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def Humanitarian_LF3(x):
    log_file = f"D:/IITB/LF/LFs/SubMission/csv/Humanitarian_LF3_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def Humanitarian_LF4(x):
    log_file = f"D:/IITB/LF/LFs/SubMission/csv/Humanitarian_LF4_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def Humanitarian_LF5(x):
    log_file = f"D:/IITB/LF/LFs/SubMission/csv/Humanitarian_LF5_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def Humanitarian_LF6(x):
    log_file = f"D:/IITB/LF/LFs/SubMission/csv/Humanitarian_LF6_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def Humanitarian_LF7(x):
    log_file = f"D:/IITB/LF/LFs/SubMission/csv/Humanitarian_LF7_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def Humanitarian_LF8(x):
    log_file = f"D:/IITB/LF/LFs/SubMission/csv/Humanitarian_LF8_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def Humanitarian_LF9(x):
    log_file = f"D:/IITB/LF/LFs/SubMission/csv/Humanitarian_LF9_logs_{datetime.now().strftime('%Y%m%d')}.csv"
...
def Humanitarian_LF10(x):
    log_file = f"D:/IITB/LF/LFs/SubMission/csv/Humanitarian_LF10_logs_{datetime.now().strftime('%Y%m%d')}.csv"
