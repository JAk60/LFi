...
def MinimumTime_LF1(x):
    log_file = f"./csv/MinimumTime_LF1_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
...
def MinimumTime_LF2(x):
    log_file = f"./csv/MinimumTime_LF2_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
...
def MinimumTime_LF3(x):
    log_file = f"./csv/MinimumTime_LF3_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
...
def MinimumTime_LF4(x):
    log_file = f"./csv/MinimumTime_LF4_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
...
def MinimumTime_LF5(x):
    log_file = f"./csv/MinimumTime_LF5_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
...
def MinimumTime_LF6(x):
    log_file = f"./csv/MinimumTime_LF6_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
...
def MinimumTime_LF7(x):
    log_file = f"./csv/MinimumTime_LF7_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
...
def MinimumTime_LF8(x):
    log_file = f"./csv/MinimumTime_LF8_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
...
def MinimumTime_LF9(x):
    log_file = f"./csv/MinimumTime_LF9_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
...
def MinimumTime_LF10(x):
    log_file = f"./csv/MinimumTime_LF10_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
