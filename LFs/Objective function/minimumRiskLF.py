...
def MinimumRisk_LF1(x):
    log_file = f"./csv/MinimumRisk_LF1_logs_" + \
...
def MinimumRisk_LF2(x):
    log_file = f"./csv/MinimumRisk_LF2_logs_" + \
        datetime.now().strftime('%Y%m%d') + ".csv"
...
def MinimumRisk_LF3(x):
    log_file = f"./csv/MinimumRisk_LF3_logs_" + \
        datetime.now().strftime('%Y%m%d') + ".csv"
...
def MinimumRisk_LF4(x):
    log_file = f"./csv/MinimumRisk_LF4_logs_" + \
        datetime.now().strftime('%Y%m%d') + ".csv"
...
def MinimumRisk_LF5(x):
    log_file = f"./csv/MinimumRisk_LF5_logs_" + \
        datetime.now().strftime('%Y%m%d') + ".csv"
...
def MinimumRisk_LF6(x):
    log_file = f"./csv/MinimumRisk_LF6_logs_" + \
        datetime.now().strftime('%Y%m%d') + ".csv"
...
def MinimumRisk_LF7(x):
    log_file = f"./csv/MinimumRisk_LF7_logs_" + \
        datetime.now().strftime('%Y%m%d') + ".csv"
...
def MinimumRisk_LF8(x):
    log_file = f"./csv/MinimumRisk_LF8_logs_" + \
        datetime.now().strftime('%Y%m%d') + ".csv"
...
def MinimumRisk_LF9(x):
    log_file = f"./csv/MinimumRisk_LF9_logs_" + \
        datetime.now().strftime('%Y%m%d') + ".csv"
...
def MinimumRisk_LF10(x):
    log_file = f"./csv/MinimumRisk_LF10_logs_" + \
        datetime.now().strftime('%Y%m%d') + ".csv"
...
MinimumRisk_LFS = [
    MinimumRisk_LF1, MinimumRisk_LF2, MinimumRisk_LF3, MinimumRisk_LF4, MinimumRisk_LF5, MinimumRisk_LF6, MinimumRisk_LF7, MinimumRisk_LF8, MinimumRisk_LF9, MinimumRisk_LF10
]
