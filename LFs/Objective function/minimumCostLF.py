...
def MINIMUM_COST_LF1(x):
    log_file = f"./csv/MINIMUM_COST_LF1_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
...
def MINIMUM_COST_LF2(x):
    log_file = f"./csv/MINIMUM_COST_LF2_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
...
def MINIMUM_COST_LF3(x):
    log_file = f"./csv/MINIMUM_COST_LF3_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
...
def MINIMUM_COST_LF4(x):
    log_file = f"./csv/MINIMUM_COST_LF4_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
...
def MINIMUM_COST_LF5(x):
    log_file = f"./csv/MINIMUM_COST_LF5_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
...
def MINIMUM_COST_LF6(x):
    log_file = f"./csv/MINIMUM_COST_LF6_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
...
def MINIMUM_COST_LF7(x):
    log_file = f"./csv/MINIMUM_COST_LF7_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
...
def MINIMUM_COST_LF8(x):
    log_file = f"./csv/MINIMUM_COST_LF8_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
...
def MINIMUM_COST_LF9(x):
    log_file = f"./csv/MINIMUM_COST_LF9_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
...
def MINIMUM_COST_LF10(x):
    log_file = f"./csv/MINIMUM_COST_LF10_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
...
MINIMUM_COST_LFS = [
    MINIMUM_COST_LF1, MINIMUM_COST_LF2, MINIMUM_COST_LF3, MINIMUM_COST_LF4, MINIMUM_COST_LF5, MINIMUM_COST_LF6, MINIMUM_COST_LF7, MINIMUM_COST_LF8, MINIMUM_COST_LF9, MINIMUM_COST_LF10
]