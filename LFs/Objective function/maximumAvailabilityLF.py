...
def MAXIMUM_AVAILABILITY_LF1(x):
    log_file = f"./csv/MAXIMUM_AVAILABILITY_LF1_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
...
def MAXIMUM_AVAILABILITY_LF2(x):
    log_file = f"./csv/MAXIMUM_AVAILABILITY_LF2_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
...
def MAXIMUM_AVAILABILITY_LF3(x):
    log_file = f"./csv/MAXIMUM_AVAILABILITY_LF3_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
...
def MAXIMUM_AVAILABILITY_LF4(x):
    log_file = f"./csv/MAXIMUM_AVAILABILITY_LF4_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
...
def MAXIMUM_AVAILABILITY_LF5(x):
    log_file = f"./csv/MAXIMUM_AVAILABILITY_LF5_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
...
def MAXIMUM_AVAILABILITY_LF6(x):
    log_file = f"./csv/MAXIMUM_AVAILABILITY_LF6_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
...
def MAXIMUM_AVAILABILITY_LF7(x):
    log_file = f"./csv/MAXIMUM_AVAILABILITY_LF7_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
...
def MAXIMUM_AVAILABILITY_LF8(x):
    log_file = f"./csv/MAXIMUM_AVAILABILITY_LF8_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
...
def MAXIMUM_AVAILABILITY_LF9(x):
    log_file = f"./csv/MAXIMUM_AVAILABILITY_LF9_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
...
def MAXIMUM_AVAILABILITY_LF10(x):
    log_file = f"./csv/MAXIMUM_AVAILABILITY_LF10_logs_" + datetime.now().strftime('%Y%m%d') + ".csv"
